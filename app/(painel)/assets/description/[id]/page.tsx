...
export default async function DescriptionDetailPage({ params }: { params: { id: string } }) {
  ...
  return <AssetDetailPage generation={detail} channels={channels} assetTypeLabel="Descrição" />;
}
