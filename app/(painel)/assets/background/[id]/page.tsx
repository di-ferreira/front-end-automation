...
export default async function BackgroundDetailPage({ params }: { params: { id: string } }) {
  ...
  return <AssetDetailPage generation={detail} channels={channels} assetTypeLabel="Background" />;
}
