...
export default async function ThumbnailDetailPage({ params }: { params: { id: string } }) {
  ...
  return <AssetDetailPage generation={detail} channels={channels} assetTypeLabel="Thumbnail" />;
}
